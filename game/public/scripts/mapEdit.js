...
function init(){
  ...
  text[1] = document.getElementById("psize");
  text[2] = document.getElementById("pkind");
  text[3] = document.getElementById("pdeut");
  text[4] = document.getElementById("pfood");
  text[5] = document.getElementById("pgold");
...
function generate_map(n, d, t, g){
  ...
  for(var i = 0; i < n; i++)
  {
    ...
    switch(Math.floor(Math.random()*3)){
      ...
      case 1: kind = "agricultural"; break;
      case 2: kind = "mining";       break;
    }
    pi = Math.floor(Math.random()*planetsn);
...
function editBoxesPos(){
  ...
  if(tplanet != undefined){
    ...
    switch(document.activeElement.id)
    {
      ...
      case "psize" : k = 1; label.text = "Planet Size:"; break;
      case "pkind" : k = 2; label.text = "Planet Type:"; break;
      case "pdeut" : k = 3; label.text = "Deuterium:"; break;
      case "pfood" : k = 4; label.text = "Food:"; break;
      case "pgold" : k = 5; label.text = "Gold:"; break;
      default: label.text = "";
    }
    selstate = (k == -1 ? 1 : 2);
    // Funky positioning
    ...
    for(i = 0; i < 6; i++){
    var off = (i == 1 || i == 2 ? 1 : 0);
      text[i].style.left = Math.round(stage.x + tplanet.planetBitmap.x + pt[0] + ((k==i)*96) +96*Math.cos(i*Math.PI/8 - 5*Math.PI/16)) + "px";
      text[i].style.top = Math.round(stage.y + tplanet.planetBitmap.y - 8 + off + pt[1] + 96*Math.sin(i*Math.PI/8 - 5*Math.PI/16)) + "px";
      if(k == i){
        label.x = tplanet.planetBitmap.x + 90 + 96*Math.cos(i*Math.PI/8 - 5*Math.PI/16);
        label.y = tplanet.planetBitmap.y + 6 + 96*Math.sin(i*Math.PI/8 - 5*Math.PI/16);
      }
...
function editBoxesGetData(planet){
  ...
  text[1].value = planet.size;
  //text[1].style.width = text[1].value.width() + "px";  
  text[2].value = planet.kind;
  //text[2].style.width = text[1].value.width() + "px";
  text[3].value = planet.resources.deuterium;
  //text[3].style.width = text[2].value.width() + "px";
  text[4].value = planet.resources.food
  //text[4].style.width = text[3].value.width() + "px";
  text[5].value = planet.resources.gold;
  //text[5].style.width = text[4].value.width() + "px";
}
...
function editBoxesSetData(){
  if(tplanet != undefined){
    if(text[0].value != ""){
      ...
      tplanet.size = text[1].value;
      tplanet.kind = text[2].value;
      tplanet.resources.deuterium = parseInt(text[3].value);
      tplanet.resources.food = parseInt(text[4].value);
      tplanet.resources.gold = parseInt(text[5].value);
    }
    else{
      stage.removeChild(tplanet.planetBitmap);
